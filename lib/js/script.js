...
$(function(){
    ...
    $(".login_button").click(function(){
        if(user.connected){
            ...
            window.location.href = "https://blog.moneypot.com/oauth/authorize?app_id=2904&response_type=token&state=Meh&redirect_uri=https://luckyspinclub.github.io/wheel/.";
        }
    });
