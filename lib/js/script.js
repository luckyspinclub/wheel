/** Credits - Do not edit/remove this comment (Read http://luckyspin.cryptogame.tk/LICENSE)
...
$(function(){
    ...
    // https://moneypot.com/introducing-socketpot/
    ...
    socket.on('new_bet', function(payload) {
        setTimeout(function(){
            ...
            if(user.uname == payload.uname){
                ...
                cell1.innerHTML = "<a href=\"https://moneypot.com/bets/"+payload.id+"\" target=\"_blank\">"+payload.id+"</a>";
    ...
    $(".login_button").click(function(){
        if(user.connected){
            ...
            window.location.href = "https://moneypot.com/oauth/authorize?app_id=2904&response_type=token&state=Meh&redirect_uri=https://luckyspinclub.github.io/wheel/.";
        }
    });
